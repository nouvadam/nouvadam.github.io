...
export class Hack {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Hack.prototype);
        obj.ptr = ptr;
    ...
    */
    set_key(input) {
        wasm.hack_set_key(this.ptr, input);
    }
    /**
    * @param {number} input
    */
    release_key(input) {
        wasm.hack_release_key(this.ptr, input);
    }
    /**
    * @returns {number}
    */
    frame() {
        var ret = wasm.hack_frame(this.ptr);
        return ret;
    }
    /**
    */
    draw() {
        wasm.hack_draw(this.ptr);
    }
}
